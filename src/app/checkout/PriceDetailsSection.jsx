export const PriceDetailsSection = ({ products }) => {
  ...
  return (
    <div className="bg-white rounded-2xl text-xs md:text-[1rem] p-4 shadow  overflow-hidden">
      <h2 className="inline-flex w-[9rem] md:w-[13.75rem] overflow-hidden items-center bg-primary text-white text-xs md:text-[1rem] px-4 py-2 font-bold rounded-lg mb-4">
        Price Details
      </h2>
